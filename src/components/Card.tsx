...
const Card = (query: { title: string, desc: string, to: string, preview: string }) => {
  ...
  return (
    <div className='w-full md:flex mb-8 bg-base-200 max-w-7xl hover:bg-base-content hover:text-base-100' onClick={() => query.to[0]==='/' ? navigate(query.to) : window.open(query.to)}>
